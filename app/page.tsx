        ...
        <section className="w-full py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-700">
                We collaborate with leading educational institutions across Canada. <span className="font-medium text-blue-950">Click a logo below to visit the institution's application page.</span>
              </p>
            </div>
